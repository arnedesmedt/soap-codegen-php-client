...
use Phpro\SoapClient\Soap\ExtSoap\SoapDriver;
...
final class CombellDefaultEngineFactory
{
    public static function create(
        ...
        return new LazyEngine(
            static function () use ($options, $transport, $metadataOptions) {
                ...
                $driver = SoapDriver::createFromClient(
                    $client,
                    MetadataFactory::manipulated(
                        new SoapMetadata($client, $options->getWsdl()),
                        $metadataOptions
                    )
                );
